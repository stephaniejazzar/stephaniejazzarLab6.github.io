...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var efficiency = readData("efficiency");
        var color = readData("color");
        var fruit = readData("fruit");
        var animal = readData("animal");
        var usability= readData("usability");
        res.render('showResults', {results: [color, efficiency, rating, usability, fruit, animal]});
        console.log([color, efficiency, rating, usability, fruit, animal]);
    });
